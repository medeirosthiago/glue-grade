...
É possível também passar alguma imagem para a biblioteca com o intuito de utilizar das formas e cores presentes na imagem para uma tentativa de representação do \textit{wordcloud}.
