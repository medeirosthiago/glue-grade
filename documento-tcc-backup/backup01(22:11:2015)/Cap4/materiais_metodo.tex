...
\begin{figure}[h!]
	...
	\caption{Exemplo de uma \textit{Series}. Fonte: \citeonline{analysis-opensource}}
	\label{pandas-series}
\end{figure}
...
\begin{figure}[h!]
	...
	\caption{Criação de um \textit{DataFrame}. Fonte: \citeonline{analysis-opensource}}
...
\begin{figure}[h!]
	...
	\caption{Conteúdo de um \textit{DataFrame} pelo interpretador \textit{IPython}. Fonte: \citeonline{analysis-opensource}}
...
\begin{figure}[h]
  ...
  \caption{Exemplo de um gráfico financeiro gerado pelo \textit{matplotlib}. Fonte: \citeonline{analysis-opensource}}
...
\begin{figure}[h!]
  ...
  \caption{Exemplo de uma página \textit{web} do \textit{IPython Notebook}. Fonte: \citeonline{analysis-opensource}}
  \label{ipython-fig}
\end{figure}
