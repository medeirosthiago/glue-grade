...
\input{dados_documento}% DADOS para CAPA e FOLHA DE ROSTO

\input{configura_documento}% Configurações DO DOCUMENTO
...
\input{siglas}  % inserir lista de abreviaturas e siglas
...
\bibliography{citacoes}% Referências bibliográficas
