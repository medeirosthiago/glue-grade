...
\chapter{Exemplos de Comandos Latex}\label{cap_exemplos}

Para a escrita da monografia utilizando o latex, é necessário um conhecimento minimo sobre os recursos que o \LaTeX  oferece. Neste capítulo serão exemplificados o uso de um conjunto destes recursofilosofias a fim de ajudar na elaboração da Monografia. Este texto foi adaptado de \cite{abntex2modelo-include}.
...
\begin{verbatim}
   \include{capitulo1}      % sem a extensão .tex
\end{verbatim}

Para incluir documentos sem quebra de páginas, utilize:

\begin{verbatim}
   \input{capitulo1}      % sem a extensão .tex
\end{verbatim}
