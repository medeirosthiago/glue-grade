...
A seguir serão apresentadas as bibliotecas necessárias para a mineração de dados, através das quais é possível coletar, limpar, transformar, realizar operações e apresentar resultados proveniente dos dados da rede social \textit{LinkedIn}. Para evitar a repetição da palavra \textit{biblioteca}, será utilizado o termo \textit{pacote} para o mesmo significado no restante desta dissertação.
...
\subsubsection{API LinkedIn}\label{api-linkedin}
